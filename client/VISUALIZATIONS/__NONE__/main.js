define(["text!./data.csv", "css!./style"], function (csvdata) {
  ...
  MyClass.prototype.getData = function() { 
    return d3.csv.parse(csvdata);
  };

  MyClass.prototype.render = function (width, height) { 
    var data = this.io.dataManager().getData();//  ★
    var root_dom = this.io.createRootDom('svg');//  ★
